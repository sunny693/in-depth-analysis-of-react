...
*/
  ...
  (function (global, factory) {
      "object" === typeof exports && "undefined" !== typeof module ? factory(exports, require("react")) : "function" === typeof define && define.amd ? define(["exports", "react"], factory) : (global = global || self, factory(global.ReactDOM = {}, global.React))
      ...
      function formatProdErrorMessage(code) {
          ...
          return "Minified React error #" +
              code + "; visit " + url + " for the full message or use the non-minified dev environment for full errors and additional helpful warnings."
      }
      ...
      function setValueForProperty(node,
          name, value, isCustomComponentTag) {
          ...
          JSCompiler_inline_result$jscomp$0 || (shouldRemoveAttribute(name, value, JSCompiler_inline_result, isCustomComponentTag) && (value = null), isCustomComponentTag || null === JSCompiler_inline_result ?
              isAttributeNameSafe(name) && (null === value ? node.removeAttribute(name) : node.setAttribute(name, "" + value)) : JSCompiler_inline_result.mustUseProperty ? node[JSCompiler_inline_result.propertyName] = null === value ? 3 === JSCompiler_inline_result.type ? !1 : "" : value : (name = JSCompiler_inline_result.attributeName, isCustomComponentTag = JSCompiler_inline_result.attributeNamespace, null === value ? node.removeAttribute(name) : (JSCompiler_inline_result = JSCompiler_inline_result.type, value = 3 === JSCompiler_inline_result || 4 === JSCompiler_inline_result &&
                  !0 === value ? "" : "" + value, isCustomComponentTag ? node.setAttributeNS(isCustomComponentTag, name, value) : node.setAttribute(name, value))))
      }
      ...
      function getChildNamespace(parentNamespace, type) {
          return null ==
              parentNamespace || "http://www.w3.org/1999/xhtml" === parentNamespace ? getIntrinsicNamespace(type) : "http://www.w3.org/2000/svg" === parentNamespace && "foreignObject" === type ? "http://www.w3.org/1999/xhtml" : parentNamespace
      }
      ...
      function queueIfContinuousEvent(blockedOn, domEventName, eventSystemFlags, targetContainer, nativeEvent) {
          ...
          case "focusin":
              return queuedFocus = accumulateOrCreateContinuousQueuedReplayableEvent(queuedFocus,
                  blockedOn, domEventName, eventSystemFlags, targetContainer, nativeEvent), !0;
          case "dragenter":
      ...
      function attemptReplayContinuousQueuedEvent(queuedEvent) {
          ...
          for (var targetContainers = queuedEvent.targetContainers; 0 < targetContainers.length;) {
              ...
              if (null !== nextBlockedOn) return targetContainers = getInstanceFromNode(nextBlockedOn), null !== targetContainers &&
                  attemptContinuousHydration(targetContainers), queuedEvent.blockedOn = nextBlockedOn, !1;
      ...
      function scheduleCallbackIfUnblocked(queuedEvent, unblocked) {
          queuedEvent.blockedOn === unblocked && (queuedEvent.blockedOn = null, hasScheduledReplayAttempt ||
              (hasScheduledReplayAttempt = !0, unstable_scheduleCallback(unstable_NormalPriority, replayUnblockedEvents)))
      }
      ...
      function shallowEqual(objA, objB) {
          ...
          for (keysB = 0; keysB < keysA.length; keysB++)
              if (!hasOwnProperty$1.call(objB, keysA[keysB]) || !objectIs(objA[keysA[keysB]], objB[keysA[keysB]])) return !1;
          return !0
      }
      ...
      function containsNode(outerNode, innerNode) {
          return outerNode && innerNode ? outerNode === innerNode ? !0 : outerNode && 3 === outerNode.nodeType ? !1 : innerNode && 3 === innerNode.nodeType ? containsNode(outerNode, innerNode.parentNode) : "contains" in outerNode ? outerNode.contains(innerNode) : outerNode.compareDocumentPosition ? !!(outerNode.compareDocumentPosition(innerNode) &
              16) : !1 : !1
      }
      ...
      function processDispatchQueue(dispatchQueue, eventSystemFlags) {
          ...
          if (hasRethrowError) throw dispatchQueue = rethrowError,
              hasRethrowError = !1, rethrowError = null, dispatchQueue;
      }
      ...
      function addTrappedEventListener(targetContainer, domEventName, eventSystemFlags, isCapturePhaseListener, isDeferredListenerForLegacyFBSupport) {
          ...
          !passiveBrowserEventsSupported ||
              "touchstart" !== domEventName && "touchmove" !== domEventName && "wheel" !== domEventName || (isDeferredListenerForLegacyFBSupport = !0);
          isCapturePhaseListener ? void 0 !== isDeferredListenerForLegacyFBSupport ? targetContainer.addEventListener(domEventName, eventSystemFlags, {
                  capture: !0,
                  passive: isDeferredListenerForLegacyFBSupport
              }) : targetContainer.addEventListener(domEventName, eventSystemFlags, !0) : void 0 !== isDeferredListenerForLegacyFBSupport ? targetContainer.addEventListener(domEventName, eventSystemFlags, {
                  passive: isDeferredListenerForLegacyFBSupport
              }) :
      ...
      function dispatchEventForPluginEventSystem(domEventName, eventSystemFlags, nativeEvent, targetInst$jscomp$0, targetContainer) {
          ...
          batchedEventUpdates(function () {
              ...
              if (0 ===
                  ...
                  eventType && (useFallbackCompositionData && "ko" !== nativeEvent.locale && (isComposing || "onCompositionStart" !== eventType ? "onCompositionEnd" === eventType && isComposing && (fallbackData = getData()) : (root = nativeEventTarget, startText = "value" in root ? root.value : root.textContent, isComposing = !0)), handleEventFunc = accumulateTwoPhaseListeners(targetInst,
                  ...
                  if ((renderLanes & pendingQueue) === pendingQueue) {
                      ...
                      a: {
                          ...
                          case 0:
                              ...
                              currentLastBaseUpdate = _assign({}, currentLastBaseUpdate,
                                  pendingQueue);
                              break a;
                          case 2:
                              hasForceUpdate = !0
      ...
      function constructClassInstance(workInProgress, ctor, props) {
          ...
          workInProgress.memoizedState = null !== ctor.state && void 0 !== ctor.state ?
              ctor.state : null;
      ...
      function tryHydrate(fiber, nextInstance) {
          ...
          case 5:
              ...
              return null !==
                  nextInstance ? (fiber.stateNode = nextInstance, !0) : !1;
          case 6:
      ...
      function tryToClaimNextHydratableInstance(fiber) {
          if (isHydrating) {
              ...
              if (nextInstance) {
                  ...
                  -1025 | 2, isHydrating = !1, hydrationParentFiber = fiber
          }
      }
      ...
      function dispatchAction(fiber, queue, action) {
          ...
          if (fiber === currentlyRenderingFiber$1 || null !== pending && pending === currentlyRenderingFiber$1) didScheduleRenderPhaseUpdateDuringThisPass = didScheduleRenderPhaseUpdate = !0;
          else {
      ...
      function updateMemoComponent(current, workInProgress, Component, nextProps, updateLanes, renderLanes) {
          if (null === current) {
              ...
              if ("function" === typeof type && !shouldConstruct(type) &&
                  void 0 === type.defaultProps && null === Component.compare && void 0 === Component.defaultProps) return workInProgress.tag = 15, workInProgress.type = type, updateSimpleMemoComponent(current, workInProgress, type, nextProps, updateLanes, renderLanes);
      ...
      function updateSimpleMemoComponent(current, workInProgress, Component, nextProps, updateLanes, renderLanes) {
          if (null !==
              ...
              if (didReceiveUpdate = !1, 0 !== (renderLanes & updateLanes)) 0 !== (current.flags & 16384) && (didReceiveUpdate = !0);
      ...
      function updateClassComponent(current, workInProgress, Component, nextProps, renderLanes) {
          ...
          if (null === workInProgress.stateNode) null !== current &&
              (current.alternate = null, workInProgress.alternate = null, workInProgress.flags |= 2), constructClassInstance(workInProgress, Component, nextProps), mountClassInstance(workInProgress, Component, nextProps, renderLanes), nextProps = !0;
              ...
              oldProps !== hasNewLifecycles || oldState !== newState || didPerformWorkStackCursor.current || hasForceUpdate ? ("function" === typeof getDerivedStateFromProps$jscomp$0 && (applyDerivedStateFromProps(workInProgress, Component, getDerivedStateFromProps$jscomp$0, nextProps), newState = workInProgress.memoizedState), (contextType = hasForceUpdate || checkShouldComponentUpdate(workInProgress, Component, contextType, nextProps, oldState, newState, oldContext)) ? (getDerivedStateFromProps || "function" !==
                  ...
                  oldProps === current.memoizedProps && oldState === current.memoizedState || (workInProgress.flags |= 4), "function" !== typeof instance.getSnapshotBeforeUpdate || oldProps === current.memoizedProps && oldState === current.memoizedState || (workInProgress.flags |= 256), nextProps = !1)
          }
      ...
      function pushHostRootContext(workInProgress) {
          ...
          root.pendingContext ? pushTopLevelContextObject(workInProgress, root.pendingContext, root.pendingContext !==
              root.context) : root.context && pushTopLevelContextObject(workInProgress, root.context, !1);
      ...
      function updateSuspenseComponent(current, workInProgress, renderLanes) {
          ...
          JSCompiler_temp ?
              (showFallback = !0, workInProgress.flags &= -65) : null !== current && null === current.memoizedState || void 0 === nextProps.fallback || !0 === nextProps.unstable_avoidThisFallback || (suspenseContext |= 1);
          push(suspenseStackCursor, suspenseContext & 1);
          if (null === current) {
              if (void 0 !== nextProps.fallback && (tryToClaimNextHydratableInstance(workInProgress), current = workInProgress.memoizedState, null !== current && (current = current.dehydrated, null !== current))) return 0 === (workInProgress.mode & 2) ? workInProgress.lanes = 1 : "$!" === current.data ?
          ...
          if (null !== suspenseContext) {
              ...
              if (null !== JSCompiler_temp) {
                  ...
                  if (0 !== (executionContext & 64) || 0 === (workInProgress.mode & 2) || "$!" === JSCompiler_temp.data) workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
                      ...
                      popToNextHostParent(workInProgress), isHydrating = !0, workInProgress = mountSuspensePrimaryChildren(workInProgress, workInProgress.pendingProps.children, renderLanes), workInProgress.flags |= 1024);
      ...
      function completeWork(current, workInProgress, renderLanes) {
          ...
          case 13:
              ...
              newProps && !renderLanes && 0 !== (workInProgress.mode & 2) && (null ===
                  current && !0 !== workInProgress.memoizedProps.unstable_avoidThisFallback || 0 !== (suspenseStackCursor.current & 1) ? 0 === workInProgressRootExitStatus && (workInProgressRootExitStatus = 3) : renderDidSuspendDelayIfPossible());
      ...
      function insertOrAppendPlacementNodeIntoContainer(node, before, parent) {
          var tag = node.tag,
              isHost = 5 === tag || 6 === tag;
          if (isHost) node = isHost ? node.stateNode : node.stateNode.instance, before ? 8 === parent.nodeType ? parent.parentNode.insertBefore(node, before) : parent.insertBefore(node, before) : (8 === parent.nodeType ? (before = parent.parentNode, before.insertBefore(node, parent)) : (before = parent, before.appendChild(node)), parent = parent._reactRootContainer, null !== parent && void 0 !== parent || null !== before.onclick ||
              (before.onclick = noop));
          ...
          case 22:
              ...
              if (null !== updateQueue) {
                  ...
                  do 3 === (effect.tag & 3) && (current = effect.destroy,
                      effect.destroy = void 0, void 0 !== current && current()), effect = effect.next; while (effect !== updateQueue)
              }
              return;
          case 1:
              return;
          ...
          if (null !== workInProgress)
              for (timeoutHandle =
                  ...
                  case 1:
                      ...
                      null !== interruptedWork && void 0 !== interruptedWork && (pop(didPerformWorkStackCursor), pop(contextStackCursor));
                      break;
                  case 3:
                      popHostContainer();
                      pop(didPerformWorkStackCursor);
                      ...
                      if (null !== value && "object" === typeof value && "function" === typeof value.then) {
                          ...
                          do {
                              ...
                              if (JSCompiler_temp = 13 === workInProgress$105.tag) {
                                  ...
                                  if (null !==
                                      nextState) JSCompiler_temp = null !== nextState.dehydrated ? !0 : !1;
                                  else {
      ...
      function commitRootImpl(root, renderPriorityLevel) {
          ...
          if (null !== remainingLanes) {
              ...
              if (current !== flags && flags && flags.ownerDocument && containsNode(flags.ownerDocument.documentElement, flags)) {
                  null !== eventTimes && hasSelectionCapabilities(flags) && (current = eventTimes.start, currentRef = eventTimes.end, void 0 === currentRef && (currentRef = current), "selectionStart" in flags ? (flags.selectionStart = current, flags.selectionEnd = Math.min(currentRef, flags.value.length)) :
                      (currentRef = (current = flags.ownerDocument || document) && current.defaultView || window, currentRef.getSelection && (currentRef = currentRef.getSelection(), expirationTimes = flags.textContent.length, alternate = Math.min(eventTimes.start, expirationTimes), eventTimes = void 0 === eventTimes.end ? alternate : Math.min(eventTimes.end, expirationTimes), !currentRef.extend && alternate > eventTimes && (expirationTimes = eventTimes, eventTimes = alternate, alternate = expirationTimes), expirationTimes = getNodeForCharacterOffset(flags, alternate),
          ...
          } else root.current = finishedWork; if (rootDoesHavePassiveEffects) rootDoesHavePassiveEffects = !1, rootWithPendingPassiveEffects = root, pendingPassiveEffectsRenderPriority =
              renderPriorityLevel;
          else
      ...
      function commitBeforeMutationEffects() {
          for (; null !== nextEffect;) {
              ...
              0 === (flags & 512) || rootDoesHavePassiveEffects ||
                  (rootDoesHavePassiveEffects = !0, scheduleCallback(97, function () {
                      flushPassiveEffects();
                      return null
                  }));
              nextEffect = nextEffect.nextEffect
      ...
      function createRootImpl(container, tag, options) {
          ...
          options =
              new FiberRootNode(container, tag, null != options && !0 === options.hydrate);
      ...
      ["src", "href", "action", "formAction"].forEach(function (attributeName) {
          properties[attributeName] = new PropertyInfoRecord(attributeName,
              1, !1, attributeName.toLowerCase(), null, !0, !0)
      });
      ...
      var currentUpdateLanePriority = 0,
          ...
          lastMovementX, lastMovementY, lastMouseEvent, MouseEventInterface = _assign({}, UIEventInterface, {
              screenX: 0,
              screenY: 0,
              clientX: 0,
              clientY: 0,
          ...
          KeyboardEventInterface = _assign({}, UIEventInterface, {
      ...
      var mediaEventTypes = "abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),
          ...
          requestPaint = void 0 !== unstable_requestPaint ? unstable_requestPaint : function () {},
          syncQueue = null,
          immediateQueueCallbackNode = null,
          isFlushingSyncQueue = !1,
      ...
      var beginWork$1 = function (current, workInProgress, renderLanes) {
          ...
          if (null !== current)
              ...
              else if (0 !== (renderLanes & updateLanes)) didReceiveUpdate = 0 !== (current.flags & 16384) ? !0 : !1;
          else {
              didReceiveUpdate = !1;
              switch (workInProgress.tag) {
              case 3:
          ...
          case 2:
              ...
              workInProgress.flags |= 1;
              if ("object" ===
                  typeof context && null !== context && "function" === typeof context.render && void 0 === context.$$typeof) {
          ...
          case 17:
              return updateLanes = workInProgress.type, context =
                  workInProgress.pendingProps, context = workInProgress.elementType === updateLanes ? context : resolveDefaultProps(updateLanes, context), null !== current && (current.alternate = null, workInProgress.alternate = null, workInProgress.flags |= 2), workInProgress.tag = 1, isContextProvider(updateLanes) ? (current = !0, pushContextProvider(workInProgress)) : current = !1, prepareToReadContext(workInProgress, renderLanes), constructClassInstance(workInProgress, updateLanes, context), mountClassInstance(workInProgress, updateLanes, context, renderLanes),
      ...
      (function (devToolsConfig) {
          ...
          if ("undefined" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) devToolsConfig = !1;
          else {
      ...
      exports.unstable_createBlockingRoot = function (container, options) {
      ...
      exports.unstable_createRoot = function (container, options) {
          if (!isValidContainer(container)) throw Error(formatProdErrorMessage(299));
