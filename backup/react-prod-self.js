function ownProperty(obj, propsName) {
  ...
  function formatProdErrorMessage(code) {
    ...
    for (let i = 1; i < arguments.length; i++) url += '&args[]=' + encodeURIComponent(arguments[i]);
  ...
  function main(exports) {
    ...
    function createElementWithValidation(type, config, children) {
      ...
      if (config != null) {
        if (config.key !== undefined) ref = config.ref;
      ...
      if (childrenLength === 1) {
        ...
        for (i = 0; i < childrenLength; i++) childArray[i] = arguments[i + 2];
    ...
    exports.useCallback = function (callback, deps) { return resolveDispatcher().useCallback(callback, deps) };
    exports.useContext = function (Context, unstable_observedBits) { return resolveDispatcher().useContext(Context, unstable_observedBits) };
    exports.useDebugValue = function (a, b) { };
    exports.useEffect = function (create, deps) { return resolveDispatcher().useEffect(create, deps) };
    exports.useImperativeHandle = function (ref, create, deps) { return resolveDispatcher().useImperativeHandle(ref, create, deps) };
    exports.useLayoutEffect = function (create, deps) { return resolveDispatcher().useLayoutEffect(create, deps) };
    exports.useMemo = function (create, deps) { return resolveDispatcher().useMemo(create, deps) };
    exports.useReducer = function (reducer, initialArg, init) { return resolveDispatcher().useReducer(reducer, initialArg, init) };
    exports.useRef = function (initialValue) { return resolveDispatcher().useRef(initialValue) };
    exports.useState = function (initialState) { return resolveDispatcher().useState(initialState) };
